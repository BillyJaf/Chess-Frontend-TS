...
export function legalMovesResponseToUILegalMoves(
  legalMovesResponse: legal_moves_response,
) {
  const uiGameStates = resultingGameStatesToUIGameStates(
    legalMovesResponse.legal_moves,
  );
...
export function bestMoveResponseToUICurrentGameState(
  bestMoveResponse: best_move_response,
) {
  const uiGameStates = resultingGameStatesToUIGameStates(
    bestMoveResponse.resulting_legal_moves,
  );
...
export function resultingGameStatesToUIGameStates(
  resultingGameStates: ResultingGameState[],
) {
